...
fn tree_more_nested_calls_than_triggers_happy() {
    ...
    SnapboxCommand::new(cargo_bin!("cairo-profiler"))
        ...
        .stderr_eq(indoc!(
            "
            [WARNING] No 'Deploy' syscall in trace but CONSTRUCTOR nested call found!
            "
        ));
...
fn tree_more_nested_calls_than_triggers_missing_call_contract() {
    ...
    SnapboxCommand::new(cargo_bin!("cairo-profiler"))
        ...
        .stderr_eq(indoc!(
            ...
            thread 'main' panicked at crates/cairo-profiler/src/trace_reader.rs:255:13:
...
fn tree_mismatched_syscall_with_entrypoint() {
    ...
    SnapboxCommand::new(cargo_bin!("cairo-profiler"))
        ...
        .stderr_eq(indoc!(
            ...
            thread 'main' panicked at crates/cairo-profiler/src/trace_reader.rs:245:17:
